...
class Recorder extends Component {
  ...
  render() {
    ...
    //title can be pass as props
    const { showUIAudio, audioURL, disableFullUI } = this.props;
      ...
      <div>
        {!medianotFound ? (
          <div>
            ...
            >
              <UploadOutlined
                style={{ fontSize: "15px", color: "#08c", cursor: "pointer" }}
              />
            </button>
            <button
              onClick={(e) => {
            ...
            <div className={styles.duration_section}>
              ...
              {!recording ? <p className={styles.help}></p> : null}
            </div>
            {recording ? (
